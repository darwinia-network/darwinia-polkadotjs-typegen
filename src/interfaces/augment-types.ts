...
import { AccountData, AddressT, BalanceInfo, BalanceLock, Bloom, BondedTcHeader, Common, DepositId, ElectionResultT, EthAddress, EthBlockNumber, EthHeader, EthHeaderBrief, EthHeaderThing, EthReceiptProof, EthTransactionIndex, EthashProof, EthereumNetworkType, EthereumReceiptProof, Exposure, ExposureT, GameId, H128, IndividualExposure, KtonBalance, LockFor, LogEntry, MMRHash, MMRProof, MerkleMountainRangeRootLog, OtherAddress, OtherSignature, Power, RKT, RawHeaderThing, Reasons, Receipt, RedeemFor, RelayProposal, RewardDestination, RingBalance, Round, SpanRecord, Staked, StakingBalanceT, StakingLedgerT, StakingLock, TcBlockNumber, TcHeaderBrief, TcHeaderHash, TcHeaderMMR, TimeDepositItem, TransactionOutcome, TronAddress, TsInMs, UnappliedSlash, Unbonding } from '@darwinia/types/interfaces/darwiniaInject';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    EthHeaderThing: EthHeaderThing;
    'Option<EthHeaderThing>': Option<EthHeaderThing>;
    'Vec<EthHeaderThing>': Vec<EthHeaderThing>;
    EthHeader: EthHeader;
    ...
    TcHeaderMMR: TcHeaderMMR;
    'Option<TcHeaderMMR>': Option<TcHeaderMMR>;
    'Vec<TcHeaderMMR>': Vec<TcHeaderMMR>;
    GameId: GameId;
    'Option<GameId>': Option<GameId>;
    'Vec<GameId>': Vec<GameId>;
    MMRHash: MMRHash;
    'Option<MMRHash>': Option<MMRHash>;
    'Vec<MMRHash>': Vec<MMRHash>;
    RawHeaderThing: RawHeaderThing;
    'Option<RawHeaderThing>': Option<RawHeaderThing>;
    'Vec<RawHeaderThing>': Vec<RawHeaderThing>;
    TcHeaderBrief: TcHeaderBrief;
    'Option<TcHeaderBrief>': Option<TcHeaderBrief>;
    'Vec<TcHeaderBrief>': Vec<TcHeaderBrief>;
    BondedTcHeader: BondedTcHeader;
    'Option<BondedTcHeader>': Option<BondedTcHeader>;
    'Vec<BondedTcHeader>': Vec<BondedTcHeader>;
    RelayProposal: RelayProposal;
    'Option<RelayProposal>': Option<RelayProposal>;
    'Vec<RelayProposal>': Vec<RelayProposal>;
