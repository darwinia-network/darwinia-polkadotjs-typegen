...
import { AccountData, AddressT, BalanceInfo, BalanceLock, Bloom, Common, DepositId, ElectionResultT, EthAddress, EthBlockNumber, EthHeader, EthHeaderBrief, EthReceiptProof, EthTransactionIndex, EthashProof, EthereumNetworkType, Exposure, ExposureT, GameId, H128, IndividualExposure, KtonBalance, LockFor, LogEntry, MMRHash, MerkleMountainRangeRootLog, OtherAddress, OtherSignature, Power, RKT, RawHeaderThing, Reasons, Receipt, RedeemFor, RewardDestination, RingBalance, Round, SpanRecord, Staked, StakingBalanceT, StakingLedgerT, StakingLock, TcBlockNumber, TcHeaderHash, TimeDepositItem, TransactionOutcome, TronAddress, TsInMs, UnappliedSlash, Unbonding } from '@darwinia/types/interfaces/darwiniaInject';
