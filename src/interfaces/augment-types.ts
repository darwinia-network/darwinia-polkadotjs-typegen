...
import { AddressT, BalanceInfo, Bloom, Common, DepositId, DoubleNodeWithMerkleProof, EthAddress, EthBlockNumber, EthHeader, EthHeaderBrief, EthNetworkType, EthReceiptProof, EthTransactionIndex, ExposureT, H128, KtonBalance, LockFor, LockReasons, MerkleMountainRangeRootLog, OtherAddress, OtherSignature, Power, RK, RKT, Receipt, RedeemFor, RingBalance, Staked, StakingBalance, StakingBalanceT, StakingLedgerT, StakingLock, TimeDepositItem, TronAddress, TsInMs, Unbonding } from 'darwinia-polkadotjs-typegen/interfaces/darwiniaInject';
